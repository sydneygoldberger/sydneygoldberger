...
// let randomize = document.getElementById("randomizeBtn");
...
//     let fullPalette= [pinkPalette, orangePalette, yellowPalette, redPalette, greyPalette, greenPalette, bluePalette, purplePalette];
//     console.log(randomizeColors[Math.floor(Math.random() * randomizeColors.length)]);
//     ColorCurve1B.style.stroke = randomizeColors[0];
//     ColorCurve1A.style.stroke = randomizeColors[1];
